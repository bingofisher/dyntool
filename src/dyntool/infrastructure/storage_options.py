...
def _raise_on_unknown_data_option_keys(data_options: Mapping[str, Any]) -> None:
...
def _resolve_attr_data_format(data_options: Mapping[str, Any]) -> AttrDataFormat:
...
def _resolve_decimal_round(data_options: Mapping[str, Any]) -> int | None:
...
def _resolve_float_dtype(data_options: Mapping[str, Any]) -> str | None:
...
def _resolve_h5_compression(data_options: Mapping[str, Any]) -> str | None:
...
def _resolve_h5_compression_level(
    data_options: Mapping[str, Any],
